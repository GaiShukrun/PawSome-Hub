  ...
  return (
    ...
    <div className="loading-content">
      <div className="loader-container">
        <svg className="spinner" stroke="#f7ae65" width="100" height="100" viewBox="0 0 206 206" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <clipPath id="cut-off-bottom">
              <rect x="0" y="0" width="100" height="50" fill="#f7ae65" />
            </clipPath>
          </defs>
          <circle className="path" fill="none" strokeWidth="7" strokeLinecap="round" cx="103" cy="103" r="100"></circle>
        </svg>
